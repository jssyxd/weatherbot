...
class LocalOrderBook:
    ...
    def apply_book(self, payload: dict[str, Any]) -> LocalBookSnapshot:
        ...
        self._bids = self._levels(payload.get("bids"), "bids")
        self._asks = self._levels(payload.get("asks"), "asks")
        ...
        self.last_trade_price = self._optional_decimal(payload.get("lastTradePrice", payload.get("last_trade_price")), "last_trade_price")
        self.version += 1
